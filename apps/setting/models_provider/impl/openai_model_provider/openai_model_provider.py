...
model_dict = {
    'gpt-3.5-turbo': ModelInfo('gpt-3.5-turbo', 'The latestgpt-3.5-turbo, by OpenAI Adjust and update.', ModelTypeConst.LLM,
                               openai_llm_model_credential,
                               ),
    'gpt-3.5-turbo-0125': ModelInfo('gpt-3.5-turbo-0125',
                                    '2024-Jan-25 gpt-3.5-turbo Photo quickly. Support the length.16,385 tokens', ModelTypeConst.LLM,
                                    openai_llm_model_credential,
                                    ),
    'gpt-3.5-turbo-1106': ModelInfo('gpt-3.5-turbo-1106',
                                    '2023-Nov-6 gpt-3.5-turbo Photo quickly. Support the length.16,385 tokens', ModelTypeConst.LLM,
                                    openai_llm_model_credential,
                                    ),
    'gpt-3.5-turbo-0613': ModelInfo('gpt-3.5-turbo-0613',
                                    '[Legacy] 2023-Jun-13 gpt-3.5-turbo Photo quickly. Will be 2024-Jun-13 abandonment.',
                                    ModelTypeConst.LLM, openai_llm_model_credential,
                                    ),
    'gpt-4': ModelInfo('gpt-4', 'The latestgpt-4, byOpenAIAdjust and update.', ModelTypeConst.LLM, openai_llm_model_credential,
                       ),
    'gpt-4-turbo': ModelInfo('gpt-4-turbo', 'The latestgpt-4-turbo, by OpenAI Adjust and update.', ModelTypeConst.LLM,
                             openai_llm_model_credential,
                             ),
    'gpt-4-turbo-preview': ModelInfo('gpt-4-turbo-preview', 'The latestgpt-4-turbo-preview, by OpenAI Adjust and update.',
                                     ModelTypeConst.LLM, openai_llm_model_credential,
                                     ),
    'gpt-4-turbo-2024-04-09': ModelInfo('gpt-4-turbo-2024-04-09',
                                        '2024-Apr-9 gpt-4-turbo Photo quickly. Support the length 128,000 tokens',
                                        ModelTypeConst.LLM, openai_llm_model_credential,
                                        ),
    'gpt-4-0125-preview': ModelInfo('gpt-4-0125-preview', '2024-Jan-25 gpt-4-turboPhoto quickly. Support the length.128,000 tokens',
                                    ModelTypeConst.LLM, openai_llm_model_credential,
                                    ),
    'gpt-4-1106-preview': ModelInfo('gpt-4-1106-preview', '2023-Nov-6 gpt-4-turbo Photo quickly. Support the length.128,000 tokens',
                                    ModelTypeConst.LLM, openai_llm_model_credential,
                                    ),
}
