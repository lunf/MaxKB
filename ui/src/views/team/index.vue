<template>
  <LayoutContainer header="Members of Team">
    <div class="team-manage flex main-calc-height">
      <div class="team-member p-8 border-r">
        ...
        <div class="team-member-input">
          <el-input
            v-model="filterText"
            placeholder="Please enter the user name search."
            prefix-icon="Search"
            clearable
          />
        </div>
          ...
          <template #default="{ row }">
            <div class="flex-between">
              <div>
                ...
                <el-tag v-if="isManage(row.type)" class="default-tag">owners</el-tag>
              </div>
              <div @click.stop style="margin-top: 5px">
                <el-dropdown trigger="click" v-if="!isManage(row.type)">
                  ...
                  <template #dropdown>
                    <el-dropdown-menu>
                      <el-dropdown-item @click.prevent="deleteMember(row)">removed</el-dropdown-item>
                    </el-dropdown-menu>
                  </template>
                </el-dropdown>
              </div>
      ...
      <div class="permission-setting flex" v-loading="rLoading">
        <div class="team-manage__table">
          <h4 class="p-24 pb-0 mb-4">permission setup</h4>
...
const memberList = ref<TeamMember[]>([]) // All members
const filterMember = ref<TeamMember[]>([]) // Search after filtering list
