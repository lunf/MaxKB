...
/**
 * Includes current permissions.
 * @param permission Current authority
 * @returns  True Included false Not included
 */
...
/**
 * Deciding whether there are roles and powers.
 * @param role         The role
 * @param permissions  Authority
 * @param requiredPermissions  Authority
 * @returns
 */
